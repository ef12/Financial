...
def get_store_tickers():
    tickers = gt.get_tickers_filtered(mktcap_min=1500000, mktcap_max=10000000)
    ...
    shutil.rmtree("C:\\Users\\efrank\\Documents\\SW_Dev\\Financial\\Daily_Stock_Report\\")
    os.mkdir("C:\\Users\\efrank\\Documents\\SW_Dev\\Financial\\Daily_Stock_Report\\")
    ...
    while (i < len(tickers)) and (Amount_of_API_Calls < 1800):
        try:
            ...
            Hist_data.to_csv("C:\\Users\\efrank\\Documents\\SW_Dev\\Financial\\Daily_Stock_Report\\"+stock+".csv")  # Saves the historical data in csv format for further processing later
