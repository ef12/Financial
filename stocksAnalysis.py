...
def analyseStocks():
    list_files = (glob.glob("C:\\Users\\efrank\\Documents\\SW_Dev\\Financial\\Daily_Stock_Report\\*.csv")) # Creates a list of all csv filenames in the stocks folder
    ...
    df.to_csv("C:\\Users\\efrank\\Documents\\SW_Dev\\Financial\\Daily_Stock_Report\\OBV_Ranked.csv", index = False)  # Save the dataframe to a csv without the index column
